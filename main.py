...
filterGrafLabel1.place(x=90, y=0)
...
filterGrafKategorija.place(x=0, y=60)

filterGrafLabel2 = CTkLabel(filterGrafHolder, text="Iznos", font=("Arial Bold", 10))
filterGrafLabel2.place(x=0, y=90)
filterLabel2 = CTkLabel(filterGrafHolder, text="Od", font=("Arial Bold", 10))
filterLabel2.place(x=0, y=120)
filterLabel2 = CTkLabel(filterGrafHolder, text="Do", font=("Arial Bold", 10))
filterLabel2.place(x=80, y=120)
filterGrafIznosOd = CTkTextbox(filterGrafHolder, height = 20, width = 75, font=("Arial Bold", 16))
filterGrafIznosOd.place(x=0, y=150)
filterGrafIznosDo = CTkTextbox(filterGrafHolder, height = 20, width = 75, font=("Arial Bold", 16))
filterGrafIznosDo.place(x=80, y=150)

filterGrafLabel2 = CTkLabel(filterGrafHolder, text="Kategorija", font=("Arial Bold", 10))
filterGrafLabel2.place(x=0, y=190)
placaCheck = IntVar() 
hranaCheck = IntVar() 
racuniCheck = IntVar() 
autoCheck = IntVar() 
...
ostaloCheck = IntVar() 
style = ttk.Style()
style.configure("CHKBTN.TCheckbutton", background="gray20", foreground="white")
Button1 = ttk.Checkbutton(filterGrafHolder, text = "Placa", variable = placaCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button2 = ttk.Checkbutton(filterGrafHolder, text = "Hrana", variable = hranaCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button3 = ttk.Checkbutton(filterGrafHolder, text = "Racuni", variable = racuniCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button4 = ttk.Checkbutton(filterGrafHolder, text = "Auto", variable = autoCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button5 = ttk.Checkbutton(filterGrafHolder, text = "Stan", variable = stanCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button6 = ttk.Checkbutton(filterGrafHolder, text = "Ostalo", variable = ostaloCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
Button1.place(x=0, y=220)
Button2.place(x=0, y=240)
Button3.place(x=0, y=260)
Button4.place(x=0, y=280)
Button5.place(x=0, y=300)
Button6.place(x=0, y=320)
...
filterGrafLabel2.place(x=0, y=350)
...
filterGrafDatumOd.place(x=0, y=380)
...
filterGrafDatumDo.place(x=0, y=420)

filterGrafBtn = CTkButton(filterGrafHolder, width=15, text="Prikaz", command=plot)
filterGrafBtn.place(x=0, y=460)
...
ButtonTable1 = ttk.Checkbutton(filterHolder, text = "Placa", variable = placaTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
ButtonTable2 = ttk.Checkbutton(filterHolder, text = "Hrana", variable = hranaTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
ButtonTable3 = ttk.Checkbutton(filterHolder, text = "Racuni", variable = racuniTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
ButtonTable4 = ttk.Checkbutton(filterHolder, text = "Auto", variable = autoTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
ButtonTable5 = ttk.Checkbutton(filterHolder, text = "Stan", variable = stanTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
ButtonTable6 = ttk.Checkbutton(filterHolder, text = "Ostalo", variable = ostaloTableCheck, onvalue = 1, offvalue = 0, width = 10, style="CHKBTN.TCheckbutton") 
